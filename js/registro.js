...
function handleRegister() {
  ...
  // Validaciones
  if (!nombre || !apellido)         return showError('Por favor ingresa tu nombre y apellido.');
  if (!isValidEmail(email))         return showError('Ingresa un correo electrónico válido.');
  if (telefono && !isValidPhone(telefono)) return showError('Ingresa un número de teléfono válido.');
